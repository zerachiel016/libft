...
/*   Updated: 2025/10/25 02:07:55 by zdadsi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *ft_strtrim(char const *s1, char const *set) {
  ...
  size_t r_trim = ft_strlen(s1);

  while (r_trim && ft_strchr(set, s1[r_trim - 1]))
    r_trim--;

  char *trimmed = malloc(r_trim + 1);
  if (trimmed)
    trimmed = ft_memcpy(trimmed, s1, r_trim);
